...
# Alias must be provided when running non-interactively (e.g., PowerShell Universal).
if ([string]::IsNullOrWhiteSpace($Alias)) {
    throw "Alias is required. Example: -Alias 'jdoe'"
}

# Commit is controlled via -Commit $true/$false (default: $false). No interactive prompt.
